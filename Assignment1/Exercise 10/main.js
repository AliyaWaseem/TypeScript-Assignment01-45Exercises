...
// then print the name with and without the whitespace.
let myname = "\n\t  Muhammad Waseem  \t\n"; // Name with whitespace
console.log("Name with whitespace:", myname);
let strippedName = myname.trim(); // Remove leading and trailing whitespace
console.log("Stripped name:", strippedName);
//Program:2
// MyName: Aliya Azeem
// Date: 2024-02-24
// Store your favorite number in a variable,
// then create and print a message revealing the favorite number.
let favoriteNumber = 3; // Favorite number
let message = `My favorite number is "${favoriteNumber}".`; // Message revealing favorite number
console.log(message);
