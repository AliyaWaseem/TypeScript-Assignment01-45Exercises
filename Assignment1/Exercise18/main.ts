...
let placesTovisit: string[] = ["Paradise","Mount Everest","Disney land","Kashmir","HariPur"];
...
console.log("Original Order after reverse sorting:", placesTovisit);
 ...
 console.log("Original Array Stored in Reverse Alphabetical Order:",placesTovisit.reverse());
